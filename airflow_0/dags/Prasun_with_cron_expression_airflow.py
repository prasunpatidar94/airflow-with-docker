...
@dag(
    dag_id="Prasun_with_cron_expression_airflow",
    start_date=datetime(2024,5,18),
    schedule_interval='0 0 * * *',
    catchup=False
)
def Prasun_with_cron_expression_airflow_workflow():

    @task()
    def run_job():
        print("job run  huaa witnh cron expression ke sath ******************************************")

    run_job()

Prasun_with_cron_expression_airflow_workflow()
...
# @dag(dag_id="Prasun_with_cron_expression_airflow",
